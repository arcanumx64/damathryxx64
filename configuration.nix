...

{
  ...
  boot = {
    ...
    kernelParams = [
      ...
      "i915.enable_psr=1"     # Enable Panel Self-Refresh for Intel GPU
      "i915.enable_fbc=1"     # Enable Frame Buffer Compression for Intel
      "i915.modeset=1"        # Enable Intel modesetting
    ];
  ...
  hardware = {
    ...
    opengl.extraPackages = with pkgs; [
      vaapiIntel          # VA-API support for Intel GPU
